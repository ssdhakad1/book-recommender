...
// Covers every genre in the UI dropdown plus aliases for fuzzy matching.
const GENRE_MAP = {
  // ── UI dropdown genres (exact lowercase match) ──
  "action & adventure":   ['adventure', 'action and adventure'],
  "art & design":         ['art', 'art history', 'visual arts'],
  ...
  "humor & comedy":       ['humor', 'comedy', 'wit and humor'],
  ...
  "mythology & folklore": ['mythology', 'folklore', 'fairy tales'],
  "non-fiction":          ['biography', 'history', 'popular science'],
  ...
  "political fiction":    ['political fiction', 'political science'],
  ...
  "mythology":            ['mythology', 'folklore', 'fairy tales'],
  "nonfiction":           ['biography', 'history', 'popular science'],
  "non fiction":          ['biography', 'history', 'popular science'],
  "satire":               ['satire', 'humor'],
